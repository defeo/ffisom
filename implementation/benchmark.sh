...
command="import os; sys.path.append(os.getcwd()); from benchmark import *; benchmark(pbound=[$2, $3], nbound=[$4, $5], prime=$6, loops=$7, tmax=$8, verbose=True, write=True, overwrite=False, fname=os.getcwd()+'/$fname', $9)"
