...
class NmodFastIrred {
public:
	void compute_qpower(nmod_poly_t result, const nmod_poly_t g, slong k, slong r);
	...
	void irred_prime_power_shoup(nmod_poly_t irred, slong r, slong e, mp_limb_t p);
	void irred_prime_power_adleman_lenstra(nmod_poly_t irred, slong r, slong e, mp_limb_t p);
	void irred_prime_power_adleman_lenstra_factor(nmod_poly_t irred, slong r, slong e, mp_limb_t p);
}
;
