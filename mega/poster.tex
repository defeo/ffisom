\documentclass[20pt,landscape,a0paper,blockverticalspace=25mm]{tikzposter}
...
\definetitlestyle{WLogos}{
   ...
   \draw
   (\titleposleft+1em,0.5*\titlepostop+0.5*\titleposbottom)
   node[anchor=west]{\includegraphics[width=20em]{uvsq-logo-cmjn}}
   (\titleposleft/2,\titlepostop-1.5em)
   node[anchor=north east]{\includegraphics[height=8em]{Anssi}}
   (\titleposright/2,\titlepostop-1.5em)
   node[anchor=north west]{\includegraphics[height=8em]{Anssi}}
   (\titleposright-1em,0.5\titlepostop+0.5*\titleposbottom)
   node[anchor=east]{\includegraphics[width=20em]{western}};
}
...
\begin{columns}
  ...
  \column{0.25}
  \makeatletter
  \setlength{\TP@blockverticalspace}{15mm}
  \makeatother
