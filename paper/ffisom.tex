...
small values of $q$ and $r$: we tested all primes $\ell$ up to $1000$,
all odd prime divisors $r$ of $\ell-1$, all primes $q$ up to a bound
depending on $\ell$, and all curves defined over $\F_q$. %
...
in~\cite[Appendix~C.2]{ffisom-long}, the source code for our tests is
available at
