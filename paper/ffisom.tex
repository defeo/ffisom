...
generators of the \textit{Teichmüller subgroups} of $k[\zeta]$ and $\F_q[\zeta]$, respectively. 
...
Since $\tau_1$ and $\tau_2$ both generate the Teichmüller subgroup of $\F_q[\zeta]$,
