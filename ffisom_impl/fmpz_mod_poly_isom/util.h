...
public:
	 ...
	 * It is assumed that {@code modulus} is prime.
	 */

	slong compute_multiplicative_order(slong a, slong modulus);
	...
	slong compute_multiplicative_order(const fmpz_t a, slong modulus);
	 ...
	 */
	bool is_small_cyclotomic_ext(slong degree, const fmpz_t p);
