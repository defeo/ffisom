...
def find_root_order(p, n, r = 0, accept = None):
    '''
    ...
    2'. gcd(r, o) = 1 and gcd(n, r⋅o / gcd(n, r⋅o)) = 1; 
...
def sieve(p, n, r, accept=None):
    ...
    - it takes five arguments (p, n, l, e, s), where p, n, l and e are integers
...
def accept(p, n, l, e, s):
    ...
    if l != 2 and p != l:
        m = l**e
        ord = (l - 1) * l**(e-1)
        return ((ord // s.expand()).gcd(n) == 1 and                   # (3')
