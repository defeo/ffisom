...
\author[1]{Ludovic Brieulle}
\author[1,2]{Luca De Feo\footnote{Corresponding author: \texttt{luca.de-feo@uvsq.fr}}}
\author[3]{Javad Doliskani}
\author[4]{Jean-Pierre Flori}
\author[3]{\'Eric Schost}
\affil[1]{Laboratoire de Math\'ematiques de Versailles,
  UVSQ, CNRS, Universit\'e Paris-Saclay}
\affil[2]{Inria, Universit\'e Paris-Saclay}
\affil[3]{University of Waterloo}
\affil[4]{Agence Nationale de S\'ecurit\'e des Syst\`emes d'Information}
