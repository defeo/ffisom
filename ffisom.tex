...
Therefore, both curves can not be used.
...
and they all have irreducible kernel polynomials.
Therefore, they can be used with $r = 3$ and $d = 7$,
and $r = 7$ and $d = 3$.
...
and they all have irreducible kernel polynomials.
Therefore, they can be used with $r = 3$ and $d = 11$,
and $r = 11$ and $d = 3$.
...
Therefore, all these curves can only be used with $r = 3$ and $d = 2$.
...
and compute periods for $r = 5$ and $d = 2$.
