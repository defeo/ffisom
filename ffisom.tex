...
\subparagraph{Case 1.}
  We take $f$ of degree $m$ in $\F_q[x]$ and we define
...
\subparagraph{Case 2.}
  As a particular case of the above, $f$ is a factor of
...
\subparagraph{Case 3.}
  We take $f$ of degree $m$ in $\F_q[X]$, and
...
\subparagraph{Case 4.}
  As a particular case of the previous item, suppose that
...
\subparagraph{Case 5.}
  As another particular case of Case 3, suppose that $g$
