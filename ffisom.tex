...
\todo{Say a word about~\cite{narayanan2016fast}}
...
improvements to the original variants of Allombert
that largely outperform them both in theory and practice. %
...
its revision~\cite{Allombert02-rev},% and another variation,
...
we extracted the details from PARI/GP source code
...
and the matrix of $\sigma$ of for Frobenii computation
...
The above way of evaluating $\hat{h}$ looks involved.
One could simply use Paterson--Stockmeyer algorithm~\cite{paterson_stockmeyer}
