...
and known to have rational $l$-torsion over an extension of degree $r$,
and check that the content of $x + m_i(x)$ does not contain
...
The next suitable values for $r$ and $l$ become prohibitevily large.
...
In fact, more general facts prevent rational curves with $29$-torsion
over a septic extension of $\Q$ to exist and prevent the extension
of strategy 3 to other prime values $l$.
Indeed, there is no rational elliptic curve with prime $l$-torsion
over extensions of degree less than $l-1$ when $l \geq 11$,
implying that we can not use such values of $l$ with any $d$,
except for $l = 11, 17, 19, 43, 67, 163$ for which the bound is $(l-1)/2$,
and the exceptional values $l = 13$ and $l = 37$~\cite{Lozano-Robledo2013},
all of which equipped with rational $l$-isogenies
and corresponding to non-cuspidal rational points on $X_0(N)$.
For $l = 11, 17, 19, 43, 67, 163$, there are only finitely many
rational elliptic curves reaching the $(l-1)/2$ bound,
...
For $l = 37$, the only rational elliptic curve breaking the bound
is the one with $j$-invariant $-7\cdot11^3$,
which comes with a rational $37$-isogeny~\cite{Mazur1974},
yielding $37$-torsion over an extension of $\Q$ of degree $(l-1)/3 = 12$
(and abscissae of the torsion points defined over a sextic subextension).
