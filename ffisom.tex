...
Contrary to strategy 2, larger values of $d$ are of little interest.
Indeed, there is no rational elliptic curve with prime $l$-torsion
over extensions of degree less than $(l-1)/2$,
except for $l = 13$ and $l = 37$~\cite{Lozano-Robledo2013}.
For $l = 13$, as aforementioneds there is an infinite family of rational
elliptic curves with $13$-torsion defined over a cubic extension.
For $l = 37$, the only rational elliptic curve breaking the bound is the one
...
For other prime values of $l \neq 13, 37$, the above constraint
implies $d r = (l-1)/2$.
Therefore the only case of interest would be $d = 2$
and having the abscissae of the torsion points defined
over a subextension of degree $(l-1)/4$.
