...
Therefore, for small values of $q$,
one can generate random elliptic curves over $\F_q$,
select those with $l$-torsion over an extension of small degree $r$,
...
of $\F_q^r$ are represented as polynomials with coefficients in $\F_q$,
