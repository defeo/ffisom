...
\subparagraph{Case 4.}
  As a particular case of Case~3, suppose that
  $g$ is in $\F_q[Z]$.
  
  Then, the cost for computing $z^q$ is
...
\subparagraph{Case 5.}
  ...
  for some $a$ in $Q$, e.g. a factor of a cyclotomic polynomial.
