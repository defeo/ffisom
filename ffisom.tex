...
only $l = 13$ provides and infinite family~\cite{Lozano-Robledo2013}.
For $l = 11, 17, 19, 43, 67, 163$, there are only finitely
many rational elliptic curves equipped with a rational $l$-isogeny;
moreover their $l$-torsion only gets defined over an extension of $\Q$
of degree $(l-1)/2$.
...
$37$-isogeny: the one with $j$-invariant $-7\cdot11^3$ (whose $37$-torsion
is defined over an extension of $\Q$ of degree $(l-1)/3 = 12$
and the abscissae of the torsion points are defined over a sextic subextension)
and the rational elliptic curve with $j$-invariant $-7\cdot137^3\cdot2083^3$.
