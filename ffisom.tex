...
and experimental evidence described in Appendix~\ref{}
together with the discussion below suggest
...
of $q$ and $r$, but we found so far.
...
couterexample where found by small scale experiments.
