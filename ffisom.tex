...
and they both have irreducible kernel polynomials.
Therefore, they both can be used with $r = 3$ and $d = 7$,
and $r = 7$ and $d = 3$.
...
and they both have irreducible kernel polynomials.
Therefore, they both can be used with $r = 3$ and $d = 11$,
and $r = 11$ and $d = 3$.
...
Therefore, the former curves can only be used with $r = 3$ and $d = 2$,
...
and check that the kernel polynomial of the candidate counterexamples
factors as expected over $\F_p$.
